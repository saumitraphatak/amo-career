...
def test_site_ux_features_present() -> None:
    ...
    assert_contains("js/main.js", "function initCalculatorPresets")
    assert_contains("js/main.js", "function initWorkedExamples")
    ...
    assert_contains("js/main.js", "Rb87 tweezer")
    assert_contains("js/main.js", "Paper-to-tool bridge")
    assert_contains("css/styles.css", ".calculator-presets-panel")
